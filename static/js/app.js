...
d3.json("/regions").then(function(data)  {  
    ...
    var  bubbleData  =   [  {     x:  Object.values(data["Region"]),     y:  Object.values(data["popularity"]),     text:  Object.values(data["topgenre"]),     mode:   "markers",     marker :  {       size:  Object.values(data["popularity"]),        // size: Object.values(data["topgenre"]),
                  color:  Object.values(data["popularity"]),       colorscale:   "Earth",      }   }];
